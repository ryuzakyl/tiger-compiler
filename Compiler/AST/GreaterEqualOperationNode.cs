...
{
    public class GreaterEqualOperationNode : RelationalOperationNode
    {
        public GreaterEqualOperationNode(IToken token) : base(token)
        {
        ...
        public override void GenerateCode(ILCodeGenerator cg)
        {
            ...
            else
            {
                ...
                cg.ILGenerator.Emit(OpCodes.Ldc_I4, -1);
